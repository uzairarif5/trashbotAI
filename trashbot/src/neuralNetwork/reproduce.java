...
public class reproduce {
	...
	public static void reproduceTwoShooters(int num,int num2) {
	    ...
	    cl.createAndWrite("biases2", sc.biases2,i);
	    cl.createAndWrite("biases3", sc.biases3,i);
	    //cl.createAndWrite("biases4", sc.biases4,i);
	    cl.createAndWrite("plinks", sc.plinks,i);
	    System.out.println("Shooter " + Integer.toString(i+1) + " weights and biases set.");
		}
	}
	...
	public static void cloneAndMutate(int[] si, int[] fi) throws Exception {
		...
		while(i<si.length) {
		    ...
		    cl.createAndWrite("biases2", sc.biases2,fi[i]);
		    cl.createAndWrite("biases3", sc.biases3,fi[i]);
		    //cl.createAndWrite("biases4", sc.biases4,fi[i]);
		    cl.createAndWrite("plinks", sc.plinks,fi[i]);
		    System.out.println("Shooter " + Integer.toString(fi[i]+1) + " weights and biases set.");
			i++;
		}
